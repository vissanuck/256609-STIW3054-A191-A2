    ...
    public void getFollowing() {
        try {
            for (int i = 0; i < GithubData.following.size(); i++) {
                ...
                int c = 1;
                do {
                    HttpURLConnection conn = (HttpURLConnection) new URL(GithubData.following.get(i).getData0() + "?per_page=100&&page=" + c + "&&access_token=323c11e265f9037d7a5260ee1720013fad46aa92").openConnection();
