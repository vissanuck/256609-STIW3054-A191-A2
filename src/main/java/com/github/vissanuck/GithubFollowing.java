    ...
    public void getFollowing() {
        try {
            for (int i = 0; i < GithubData.following.size(); i++) {
                ...
                int c = 1;
                do {
                    HttpURLConnection conn = (HttpURLConnection) new URL(GithubData.following.get(i).getData0() + "?per_page=100&&page=" + c + "&&access_token=574b320e15060d877312dfb80e9c953919a12976").openConnection();
