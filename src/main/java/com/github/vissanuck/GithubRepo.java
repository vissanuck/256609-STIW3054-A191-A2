    ...
    public void getRepo()
    {
        try
        {
            for (int i = 0; i <GithubData.repo.size(); i++)
            {
                ...
                int a = 1;
                do {
                    HttpURLConnection conn = (HttpURLConnection) new URL(GithubData.repo.get(i).getData0() + "?per_page=100&&page=" + a + "&&access_token=574b320e15060d877312dfb80e9c953919a12976").openConnection();
