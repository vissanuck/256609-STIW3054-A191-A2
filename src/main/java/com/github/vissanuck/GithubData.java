...
public class GithubData
    {
        ...
        public void getData()
        {
            try
            {
                for (int i = 1; i <= 2; i++)
                {
                    HttpURLConnection conn = (HttpURLConnection) new URL("https://api.github.com/users/zhamri/followers?per_page=100&page=" + i + "&&access_token=574b320e15060d877312dfb80e9c953919a12976").openConnection();
