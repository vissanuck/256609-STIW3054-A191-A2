...
public class GithubData
    {
        ...
        public void getData()
        {
            try
            {
                for (int i = 1; i <= 2; i++)
                {
                    HttpURLConnection conn = (HttpURLConnection) new URL("https://api.github.com/users/zhamri/followers?per_page=100&page=" + i + "&&access_token=9efa7d7cf9b425df53be1ebbb6f1c30ad9bcce9c").openConnection();
