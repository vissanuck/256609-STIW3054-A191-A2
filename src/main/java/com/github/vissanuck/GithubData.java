...
public class GithubData
    {
        ...
        public void getData()
        {
            try
            {
                for (int i = 1; i <= 2; i++)
                {
                    HttpURLConnection conn = (HttpURLConnection) new URL("https://api.github.com/users/zhamri/followers?per_page=100&page=" + i + "&&access_token=323c11e265f9037d7a5260ee1720013fad46aa92").openConnection();
